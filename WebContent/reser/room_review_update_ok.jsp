...
try{
	...
	int room_review_idx =
			Integer.parseInt(multi.getParameter("room_review_Idx"));
	dto.setRoom_review_idx(room_review_idx);
	int room_review_starScore = 
			Integer.parseInt(multi.getParameter("room_review_starScore"));
...
int r = rrdao.updateRoomReview(dto);
