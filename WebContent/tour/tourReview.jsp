	...
	<section  style="background-color: white;">
		...
		<article>
			<div class="reviewlist">
				...
				<td colspan="6" class="desc"><select name="how" id="selectbox" onchange="change()">
					...
					<option value="review_star">별점</option><input type="hidden" name="tour_ref" value="<%=tour_ref%>">
				</select>
					...
					<tr>
						...
						<td class="longtd">&nbsp;&nbsp;<a
							href="reviewContent.jsp?review_idx=<%=arr.get(i).getReview_idx()%>"><span
								class="sp">[<%=name%>]
							</span> <%=arr.get(i).getReview_subject()%>
								<%
		...
		<article>
			<div class="page">
				...
				%>
				<a
					href="tourReview.jsp?cp=<%=(userGroup - 1) * pageSize + pageSize%>&tour_ref=<%=tour_ref%>">&lt;&lt;</a>
				<%
					//그룹값 중 가장 큰 숫자 공식
				}
				%>
