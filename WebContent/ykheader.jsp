...
function gogo(){
	...
	window.open('/semi/yk_member/yk_login.jsp','login','width=500,height=290,left=300,top=100');
}
function logout(){
...
<img src="/semi/img/548.png"  class="logoimg">
...
<li class="menuli Qnaa"><a href="/semi/qna/qnaList.jsp">Q&A</a></li>

<%
if(master==1){
	%>
	<li class="master"><a href="/semi/master/masterPage.jsp">관리자페이지</a></li>
	<%
}
